...
# 명암도
gray2gray = cv2.imread("C:/Users/JihoonHuh/Images/Road_gray.JPG", cv2.IMREAD_GRAYSCALE)
# 컬러 영상
gray2color = cv2.imread("C:/Users/JihoonHuh/Images/Road_gray.JPG", cv2.IMREAD_COLOR)
